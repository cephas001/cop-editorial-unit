<template>
  <div ref="dropdownContainer">
    <button
      ...
      class="text-black dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full p-2 transition-colors duration-200 flex items-center justify-center relative"
