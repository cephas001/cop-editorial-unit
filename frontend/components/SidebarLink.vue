<template>
  <NuxtLink
    ...
    :class="
      route.fullPath == to &&
      'bg-indigo-50 text-indigo-700 dark:text-indigo-300 dark:bg-indigo-500/10'
    "
    @click="$emit('click')"
  >
    <div
      class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-indigo-600 dark:bg-indigo-400 rounded-r-full"
