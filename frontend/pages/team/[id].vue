      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        >
          ...
          <div class="flex-1 pb-2">
            ...
            <div
              class="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm text-slate-600 dark:text-slate-400"
            >
              <span
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        <div class="lg:col-span-5 flex flex-col gap-8">
          <section>
            ...
            <div
              class="text-base text-slate-600 dark:text-slate-300 leading-relaxed whitespace-pre-wrap text-center"
            >
        ...
        <div class="lg:col-span-7 mt-5">
          <section>
            ...
            <div
              ...
              class="text-center py-12 text-slate-500 font-mono"
            >
            ...
            <div v-else class="flex flex-col gap-4">
              <article
                ...
                :key="article.id"
                class="group bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden"
              >
                <div
